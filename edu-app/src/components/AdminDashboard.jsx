...
//     try {
//       // Prepare payload with correct field names matching PHP expectations
//       const payload = {
//         firstname: newTeacher.firstname.trim(),
//         lastname: newTeacher.lastname.trim(),
//         email: newTeacher.email.trim(),
//         password: newTeacher.password,
//         phone: newTeacher.phone ? newTeacher.phone.trim() : '',
//         department: newTeacher.department ? newTeacher.department.trim() : '',
//         specialization: newTeacher.specialization ? newTeacher.specialization.trim() : '',
//         teacher_id: newTeacher.teacher_id ? newTeacher.teacher_id.trim() : '',
//         subjects: selectedSubjects,
//         classes: selectedClasses
//       };
...
//                     <input
//                       type="text"
//                       placeholder="Teacher ID (Optional - Auto-generated)"
