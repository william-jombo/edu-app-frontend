...
// frontend/src/components/teacher/announcements/TeacherAnnouncementsWidget.jsx
...
const teacherAnnouncementsAPI = {
  getAnnouncements:       async ()      => get('/api/teachers/announcements.php?action=list').then(r => r.json()),
  getUnreadCount:         async ()      => get('/api/teachers/announcements.php?action=unread_count').then(r => r.json()),
  getRecentAnnouncements: async (n = 5) => get(`/api/teachers/announcements.php?action=recent&limit=${n}`).then(r => r.json()),
  markAsRead:             async (id)    => post('/api/teachers/announcements.php?action=mark_read', { announcement_id: id }).then(r => r.json()),
  markAllAsRead:          async ()      => post('/api/teachers/announcements.php?action=mark_all_read', {}).then(r => r.json()),
};
